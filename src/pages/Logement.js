    ...
    <>
      ...
      <main>
        <div class="info">
          <div class="top">
            <div class="top_left">
              <div class="top_left_where">
                <h2 class="top_left_where_title">Cozy loft on the canal saint martin</h2>
                <p class="top_left_where_location">Paris, Ile de france</p>
              </div>
              <div class="top_tags">
                <div class="top_tags_tag">
                  <p>Cozy</p>
                </div>
                <div class="top_tags_tag">
                  <p>Canal</p>
          ...
          <div class="bottom">
            <div class="bottom_description">
              <p>description</p>
              <div class="bottom_description_texte">
                Profitez du charme de la vie parisienne dans un magnifique appartement. A 3 minutes à pied du Canl Saint Martin, vous serez proche des
                transports, mais également de nombreux commerces. L'appartement est tout équipé, et possède également un parking pour ceux qui
                souhaitent se déplacer en voiture.
              </div>
            </div>
            <div class="bottom_equipement">
              <p>Equipement</p>
              <ul>
                <li>Climatisation</li>
                <li>Wi-fi</li>
